...
export class BoidSystem {
    ...
    private applyupdate(entityId: number, position: ReturnType<typeof PositionComponent>, velocity: ReturnType<typeof VelocityComponent>, boid: ReturnType<typeof BoidComponent>, acceleration: ReturnType<typeof AccelerationComponent>) {
        ...
        if (position.x < 1500) velocity.x += boid.turnFactor;
        if (position.x > 0) velocity.x -=  boid.turnFactor;
        if (position.y < 1500) velocity.y +=  boid.turnFactor;
    ...
    private applySeparation(entityId: number, position: ReturnType<typeof PositionComponent>, velocity: ReturnType<typeof VelocityComponent>, boid: ReturnType<typeof BoidComponent>) {
        const entities = this.entityManager.getEntities();
    ...
    private applyAlignment(entityId: number, position: ReturnType<typeof PositionComponent>, velocity: ReturnType<typeof VelocityComponent>, boid: ReturnType<typeof BoidComponent>) {
            let xvel_avg = 0;
            let yvel_avg = 0;
    ...
    private applyCentering(entityId: number, position: ReturnType<typeof PositionComponent>, velocity: ReturnType<typeof VelocityComponent>, boid: ReturnType<typeof BoidComponent>) {
        let xpos_avg = 0;
        let ypos_avg = 0;
        let neighboring_boids = 0;
